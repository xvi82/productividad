...
let newpex = Number(convert(clean(pex)));
...
const diferencia = redondeo((((((newtrienio+newsalariobase)*14)+(newcompdest*12)+(newpex*2))/20)/4)-newcobro).toString().replace(".", ",");
